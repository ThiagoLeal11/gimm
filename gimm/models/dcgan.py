...
class DCGAN(ModuleGAN):
    def __init__(self, in_features: list[int], latent_dim: int = 100):
        super().__init__()
        ...
        self.generator = DCGANGenerator(encoding_dims=latent_dim, out_size=img_size, out_channels=channels)
