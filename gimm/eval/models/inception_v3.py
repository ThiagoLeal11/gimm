...
Copied from
Available at https://github.com/POSTECH-CVLab/PyTorch-StudioGAN/blob/master/src/metrics/inception_net.py
"""
...
class FIDInceptionE1(models.inception.InceptionE):
    ...
    def forward(self, x):
        ...
        # Patch: Tensorflow's average pool does not use the padded zero's in
        # its average calculation
        branch_pool = F.avg_pool2d(x, kernel_size=3, stride=1, padding=1, count_include_pad=self.count_include_pad)
        branch_pool = self.branch_pool(branch_pool)
